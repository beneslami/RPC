...
main(int argc, char **argv){
  int sockfd = 0, len, opt = 1, reply_msg_size = 0;
...
READ:
  ...
  len = sendto(sockfd, server_send_ser_buffer->b, get_serialize_buffer_length(server_send_ser_buffer), 0, (struct sockaddr*)&client_addr, sizeof(struct sockaddr));
